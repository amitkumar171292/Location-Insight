...
public class BGetLocation extends Service implements LocationListener {
    ...
    public BGetLocation(Context context) {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(BGetLocation.this);
        }       
    }
